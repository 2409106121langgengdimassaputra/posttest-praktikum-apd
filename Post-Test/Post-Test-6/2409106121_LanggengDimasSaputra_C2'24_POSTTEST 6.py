...
while True:
    ...
    match(pilih):
        ...
        case '3':
            ...
            index = int(input("Masukkan volume yang mau diedit: "))
            data_volume[index] = input("Masukkan volume yang anda inginkan :")
        ...
        case '4':
            ...
            for i in data_volume:
                print(f"{i}. {data_volume[i]}")
            index = int(input("Masukkan volume yang ingin dihapus: "))
